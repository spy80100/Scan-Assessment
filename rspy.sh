...
echo ' rspy - a tool that automates the nmap vulnerability scanner using nse scripts     '
echo ' rspy. 0.0                                                                           '
echo ' written by: @spy80100                                                                '
echo '                                                                                    '
echo ' usage: ./rspy.sh [ipadress_range] [protocol] [port] <Pn (optional)>               '
echo '\n'
